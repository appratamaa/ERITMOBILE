...
@Composable
fun PopupRegister(showDialog: MutableState<Boolean>, navController: NavHostController) {
    if (showDialog.value) {
        ...
        Dialog(onDismissRequest = {}) {
            Box(modifier = Modifier.background(
                ...
                Column(
                    ...
                    Text(
                        text = stringResource(R.string.databerhasildisimpan),
                    ...
                    Image(
                        painter = painterResource(R.drawable.data_berhasil_disimpan),
...
fun DialogRegisterPreview() {
    ...
    ERITMOBILETheme {
        PopupRegister(showDialog = showDialog, rememberNavController())
    }
}